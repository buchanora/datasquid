...
var EditableTextField = function (_Component) {
  ...
  EditableTextField.prototype.render = function render() {
    ...
    var displayError = error && _react2.default.createElement(
      'span',
      { style: [styles.errorMessage] },
      error
    );

    var displayMode = _react2.default.createElement(
      'div',
    ...
    var editingMode = _react2.default.createElement('input', { autoFocus: true,
      type: fieldType,
