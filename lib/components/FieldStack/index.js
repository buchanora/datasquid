...
var _MultiLineField = require('../MultiLineField/');

var _MultiLineField2 = _interopRequireDefault(_MultiLineField);

var _DateField = require('../DateField/');

var _DateField2 = _interopRequireDefault(_DateField);

var _DraftField = require('../DraftField/');

var _DraftField2 = _interopRequireDefault(_DraftField);
...
var _OptionTextField = require('../OptionTextField/');

var _OptionTextField2 = _interopRequireDefault(_OptionTextField);

var _UploadField = require('../UploadField/');

var _UploadField2 = _interopRequireDefault(_UploadField);

var _EditableTextField = require('../EditableTextField/');
...
var FieldStack = function (_Component) {
  ...
  FieldStack.prototype.render = function render() {
    ...
    return typeof render === 'function' ? render({ values: values, actions: actionMap, fieldErrors: fieldErrors, disabledFields: disabledFields, disabledForm: disabledForm, formError: formError }) : _react2.default.createElement(
      'div',
      { className: 'fieldWrap' },
    ...
    function formatField(values, _actionMap, fieldErrors, disabledFields, field, index) {
      ...
      switch (field.type) {
        ...
        case 'number':
        case 'tel':
          return _react2.default.createElement(_TextField2.default, _extends({ type: type }, props));
          break;
        case 'multilineText':
        case 'multiLineText':
        case 'multiline-text':
          return _react2.default.createElement(_MultiLineField2.default, props);
          break;
        case 'editableText':
        case 'editable-text':
          return _react2.default.createElement(_EditableTextField2.default, props);
          break;
        case 'optionText':
        case 'option-text':
          return _react2.default.createElement(_OptionTextField2.default, _extends({}, props, { options: options }));
          break;
        case 'date':
          return _react2.default.createElement(_DateField2.default, props);
          break;
        case 'time':
          return _react2.default.createElement(_TimeField2.default, props);
          break;
        case 'multiSelectFieldSet':
        case 'multi-select':
          return _react2.default.createElement(_Select.MultiSelectFieldSet, _extends({}, props, { style: style, onChange: onToggleMultiSelect, options: options }));
          break;
        case 'selectFieldSet':
        case 'select':
          return _react2.default.createElement(_Select.SelectFieldSet, _extends({ options: options }, props));
          break;
        case 'upload':
          return _react2.default.createElement(_UploadField2.default, props);
          break;
        case 'draft':
          return _react2.default.createElement(_DraftField2.default, props);
          break;
        default:
          return _react2.default.createElement(_TextField2.default, _extends({ type: type }, props));
      }
...
FieldStack.propTypes = {
  activeFieldIndex: _propTypes2.default.number, // The index of the field currently in focus. Only necessary when formdata props is present
  actions: _propTypes2.default.object.isRequired, // Customize event handler functions
  disabledForm: _propTypes2.default.bool, // Disables all form fields
  disabledFields: _propTypes2.default.object, // Disables listed fields
  formData: _propTypes2.default.object, // Configures fieldstack to auto render form
  fieldErrors: _propTypes2.default.object, // Adds error messages to listed fields
  formError: _propTypes2.default.string, // Adds error message to form
  render: _propTypes2.default.func, // Renders the returned component
  values: _propTypes2.default.object // Updates form values
};
